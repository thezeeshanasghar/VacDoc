...
export class AddPage implements OnInit {
 ...
 // Corrected the declaration and assignment
  ...
  // async checkTravel(event: any) {
  //   // Check if the selected value is 'travel'
  //   if (event.detail.value === 'travel') {
  //     this.isCnicRequired = true; // Set CNIC as required
  //   } else {
  //     this.isCnicRequired = false; // Clear the requirement
  //   }
  // }
  // onTravelChange(event: any) {
  //   this.isCnicRequired = event.detail.value === 'travel'; // Set CNIC required if travel is selected
  //   this.onTypeChange(); // Update validators based on selection
  // }

  // Method to update validators for CNIC when travel is selected
  // onTypeChange() {
  //   const cnicControl = this.fg1.get('CNIC');
  //   if (cnicControl) {
  //     if (this.isCnicRequired) {
  //       cnicControl.setValidators([Validators.required]); // Add required validator
  //     } else {
  //       cnicControl.clearValidators(); // Clear validators
  //     }
